...
class ConditionalBSplineTransformer(FlowLayer):
    def __init__(
        self,
    ...
    def forward(self, x, y, *args, elementwise_jacobian=False, **kwargs):
    ...
    def reverse(self, x, y, *args, elementwise_jacobian=False, **kwargs):
    ...
    def logdet(self, x, y, *args, **kwargs):
        pieces, widths = self._compute_params(x, y.shape[-1])
        _, dlogp = cubic_B_spline(
            y,
            pieces,
            widths,
            inverse=False,
