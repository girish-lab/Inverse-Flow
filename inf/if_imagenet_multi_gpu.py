...
from inf.layers.flowlayer import FlowLayer
from inf.train.experiment import Experiment
from inf.layers.conv import PaddedConv2d#, Conv1x1
# from inf.fastflow import FastFlowUnit
...
class Preprocess(nn.Module):
    ...
    def forward(self, x):
        ...
        for layer in self.layers:
            ...
            # print('Preprocess ><><><>< layer_logdet', layer_logdet)
            # print('x', x.shape)
            # print('Preprocess ><><><>< logdet', logdet)
...
class FastFlowStep(nn.Module):
    def __init__(self, size, actnorm=False):
        ...
        fastflow_unit = inv_flow_with_pad(size[0], size[0], (3, 3), order='TL')
...
if __name__ == '__main__':
    ...
    config = {
        'name': f'3L-48K_IF_imagenet32_{run_name}',
        'eval_epochs': 1,
        'sample_epochs': 1,
        'log_interval': 100,
        'lr': lr,
        ...
        'grad_clip_norm': 1.0,
        'grad_clip': 1.0,       # imporant for Inv_Flow model
        ...
        'dataset': 'imagenet32',
        'run_name': f'{run_name}',
        'wandb_project': 'Inverse_Flow-imagenet32-GC',
