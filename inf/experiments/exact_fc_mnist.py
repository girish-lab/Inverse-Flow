...
from inf.layers.selfnorm import SelfNormFC
from inf.layers.activations import SmoothLeakyRelu, SplineActivation, LearnableLeakyRelu
...
def create_model(num_layers=2, sym_recon_grad=False, 
    ...
    for l in range(num_layers):
        ...
        layers.append(inv_flow_no_pad(data_size[0], data_size[0], (3, 3)))
