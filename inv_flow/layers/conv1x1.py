...
class Conv1x1(FlowLayer):
    def __init__(self, n_channels):
        ...
        self.W = torch.nn.Parameter(torch.from_numpy(q_np.astype('float32'))) #, bias=False) # bias=True, (san_n)
...
class Conv1x1Householder(FlowLayer):
    def __init__(self, n_channels, n_reflections):
        ...
        self.V = torch.nn.Parameter(torch.from_numpy(v_np.astype('float32'))) #, bias=False) # bias=True, (san_n)
