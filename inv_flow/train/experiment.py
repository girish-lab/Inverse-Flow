...
default_config = {
        'name': 'Inv_Flow_MNIST',
        'notes': None,
        'wandb': True, # Set to True to log to wandb
        'wandb_project': 'Inv_Flow_MNIST',
        'wandb_entity': 'inv_flow',
        'log_timing': False,  # Log batch and sample times, False
        'eval_train': False, # Evaluate on train set, False
        ...
        'n_samples': 40,
        'sample_dir': 'samples',
        'epochs': 60, # Number of epochs to train for, 50, 80, 100
        # 'grad_clip_norm': None, #
        'eval_epochs': 1,
        'lr': 1e-4,
        'warmup_epochs': 1,
        'modified_grad': True, # Use modified grad for log_prob, False
        'add_recon_grad': True, # Add reconstruction loss to gradient, False
        'sample_true_inv': False, # Sample from true inverse, False
        'plot_recon': True,
        'checkpoint_path': None, #'/wandb/3L-32K_FastFlow_CIFAR_Epoch_14.tar',
        'early_stop_epochs': 5,
        'multi_gpu': False,
    }
